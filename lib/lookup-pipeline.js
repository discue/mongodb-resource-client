const { PROJECT, EQUALS, LOOKUP, REDUCE, CONCAT_ARRAYS, TO_OBJECT, LET, APPEND_OBJECTS, JOIN_STRINGS, EQUALS_ALL, EQUAL_ELEMENTS } = require('./aggregations.js')
...
module.exports.joinAndQueryChildResourcesPipeline = function ({ parentCollectionName, childCollectionName, options }) {
    ...
    if (options.projection) {
        pipeline.push(PROJECT({ children: options.projection }))
    }
