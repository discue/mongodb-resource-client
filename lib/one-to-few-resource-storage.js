...
module.exports = class extends Base {
    ...
    async get(resourceIds, { withMetadata = false, projection } = {}) {
        return withActiveSpan('get-one-to-few-resource-by-id', { resourceIds, resourceName: this._resourceName, databaseName: this._databaseName }, async () => {
    ...
    async getAll(resourceIds, { withMetadata = false, projection } = {}) {
        return withActiveSpan('get-all-one-to-few-resources-by-id', { resourceIds, resourceName: this._resourceName, databaseName: this._databaseName }, async () => {
            const collection = await this._getCollection()
            const aggregationStages = [
                EQUALS('id', resourceIds.at(0)),
                { $unwind: `$${this._resourceName}` },
    ...
    async create(resourceIds, resource) {
        return withActiveSpan('create-one-to-few-resource-by-id', { resourceIds, resourceName: this._resourceName, databaseName: this._databaseName }, async () => {
    ...
    async update(resourceIds, update) {
        return withActiveSpan('update-one-to-few-resource-by-id', { resourceIds, resourceName: this._resourceName, databaseName: this._databaseName }, async () => {
    ...
    async delete(resourceIds) {
        return withActiveSpan('delete-one-to-few-resource-by-id', { resourceIds, resourceName: this._resourceName, databaseName: this._databaseName }, async () => {
