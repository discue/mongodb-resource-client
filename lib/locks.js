...
module.exports = class {
    ...
    async lock(resourceIds) {
        return withActiveSpan('@discue/mongodb-resource-client:lock-resource', { resourceIds }, async () => {
    ...
    async unlock(resourceIds) {
        return withActiveSpan('@discue/mongodb-resource-client:unlock-resource', { resourceIds }, async () => {
            return this._resourceStorage.delete(resourceIds)
        })
    }
    ...
    async doWhileLocked(resourceIds, callback, { lockTimeout = 5_000, waitTimeout = 5_000, retryInterval = 125 } = {}) {
        return withActiveSpan('@discue/mongodb-resource-client:do-while-resource-locked', { resourceIds, lockTimeout, waitTimeout, retryInterval }, async () => {
