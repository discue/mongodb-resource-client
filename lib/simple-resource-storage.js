...
module.exports = class {
    ...
    async _getDb(givenClient) {
        return withActiveSpan('get-db-instance', { resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async _getCollection(collectionName, givenClient) {
        return withActiveSpan('get-db-collection', { collectionName, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async get(resourceIds, { withMetadata = false, projection } = {}) {
        return withActiveSpan('get-simple-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async getAll({ withMetadata = false, projection } = {}) {
        return withActiveSpan('get-all-simple-resources', { resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            const collection = await this._getCollection()
            const aggregationStages = []
    ...
    async find(aggregations = []) {
        return withActiveSpan('find-simple-resources', { resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            const collection = await this._getCollection()
    ...
    async exists(resourceIds) {
        return withActiveSpan('exists-simple-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async create(resourceIds, resource, options) {
        return withActiveSpan('create-simple-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async update(resourceIds, update) {
        return withActiveSpan('update-simple-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async delete(resourceIds) {
        return withActiveSpan('delete-simple-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                const resource = await this.get(resourceIds)
                if (!resource) {
                    throw new Error(`${resourceIds} does not exist.`)
