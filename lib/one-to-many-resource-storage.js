...
module.exports = class extends Base {
    ...
    async exists(resourceIds) {
        return withActiveSpan('@discue/mongodb-resource-client:exists-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async get(resourceIds, options) {
        return withActiveSpan('@discue/mongodb-resource-client:get-one-to-many-resource-by-id', { "peer.service": "resource-client", resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async _verifyReferencesUntilRootObject(resourceIds) {
        return withActiveSpan('@discue/mongodb-resource-client:verify-one-to-many-resource-references', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async getAll(resourceIds, { withMetadata = false, addDocumentPath, projection } = {}) {
        return withActiveSpan('@discue/mongodb-resource-client:get-all-one-to-many-resources-by-id', { "peer.service": "resource-client", resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async findReferences(resourceIds, verifyParentReference = true) {
        return withActiveSpan('@discue/mongodb-resource-client:find-many-resources-references-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async create(resourceIds, resource) {
        return withActiveSpan('@discue/mongodb-resource-client:create-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                ...
                if (this._enableTwoWayReferences) {
                    await this._updateUnsafe([resourceIds.at(1), newId], {
    ...
    async update(resourceIds, update) {
        return withActiveSpan('@discue/mongodb-resource-client:update-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                const resource = await this.get(resourceIds)
                if (!resource) {
    ...
    async delete(resourceIds) {
        return withActiveSpan('@discue/mongodb-resource-client:delete-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                const resource = await this.get(resourceIds)
                if (!resource) {
                    throw new Error(`${resourceIds} does not exist.`)
