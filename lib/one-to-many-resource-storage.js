...
module.exports = class extends Base {
    ...
    async exists(resourceIds) {
        return withActiveSpan('exists-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async get(resourceIds, options) {
        return withActiveSpan('get-one-to-many-resource-by-id', { "peer.service": "resource-client", resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async _verifyReferencesUntilRootObject(resourceIds) {
        return withActiveSpan('verify-one-to-many-resource-references', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async getAll(resourceIds, { withMetadata = false, addDocumentPath, projection } = {}) {
        return withActiveSpan('get-all-one-to-many-resources-by-id', { "peer.service": "resource-client", resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async findReferences(resourceIds, verifyParentReference = true) {
        return withActiveSpan('find-many-resources-references-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async create(resourceIds, resource) {
        return withActiveSpan('create-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async update(resourceIds, update) {
        return withActiveSpan('update-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                const resource = await this.get(resourceIds)
                if (!resource) {
    ...
    async delete(resourceIds) {
        return withActiveSpan('delete-one-to-many-resource-by-id', { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
            return this._withTransaction(async (session, client) => {
                const resource = await this.get(resourceIds)
                if (!resource) {
                    throw new Error(`${resourceIds} does not exist.`)
