...
module.exports = class extends Base {
    ...
    async create(resourceIds, resource) {
        return this._childEmitUsageEvent({ context: 'create', after: resource, resourceIds }, async () => {
    ...
    async delete(resourceIds) {
        ...
        return this._childEmitUsageEvent({ context: 'delete', before: resource, resourceIds }, async () => {
