...
module.exports = class extends Base {
    ...
    async _verifyReferencesUntilRootObject(resourceIds) {
        return withActiveSpan(`${name}#verify-one-to-many-resource-references`, { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
    ...
    async findReferences(resourceIds, verifyParentReference = true) {
        return withActiveSpan(`${name}#find-many-resources-references-by-id`, { resourceIds, resourceName: this._collectionName, databaseName: this._databaseName }, async () => {
